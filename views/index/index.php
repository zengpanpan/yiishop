...
<div class="i_bg bg_color">
    ...
    <div class="i_t mar_10">
        ...
        <img src="<?='https://portal.qiniu.com/bucket/shop/14897230691150D:\wamp\tmp\php9711.tmp';?>" alt="">
                        ...
                        <ul class="featureUL" style="margin: 0px; padding: 0px; position: relative; list-style-type: none; z-index: 1; width: 3600px; left: -2400px;">
                            ...
                            <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                                <div class="box">
                                    ...
                                    <div class="imgbg">
                                        <a href="<?=Url::to(['product/product','goods_id'=>$v['goods_id']]);?>"><img width="160" height="136" src="<?= $v['goods_img'];?>"></a>
                                    </div>
                                    <div class="name">
                                        <a href="<?=Url::to(['product/product','goods_id'=>$v['goods_id']]);?>">
                                            <h2><?= $v['goods_name'];?></h2>
                                            <?= $v['keywords'];?>
                                        </a>
                                    </div>
                                    <div class="price">
                                        <font>￥<span><?= $v['shop_price'];?></span></font> &nbsp; 已售<?= $v['shop_num'];?>件
                                    </div>
                                </div>
                            </li>
                            <?php endforeach;?>
...
<a href="#">进口咖啡</a>&nbsp; &nbsp; &nbsp; <a href="#">进口酒</a>&nbsp; &nbsp; &nbsp; <a href="#">进口母婴</a>&nbsp; &nbsp; &nbsp; <a href="#">新鲜蔬菜</a>&nbsp; &nbsp; &nbsp; <a href="#">新鲜水果</a></span>
    </div>
    <div class="content">
