    ...
    <div class="content mar_20">
        ...
        <div class="l_list">
            <div class="list_t">
                ...
                <span class="fr">共发现<?=$goodsCount;?>件</span>
            </div>
            <div class="list_c">
                ...
                <ul class="cate_list">
                    ...
                    <li>
                        <div class="img"><a href="<?= Url::to(['product/product','goods_id'=>$v['goods_id']]);?>"><img src="/<?= $v['goods_img'];?>" width="210" height="185" /></a></div>
                        <div class="price">
                            <font>￥<span><?= $v['shop_price'];?></span></font> &nbsp; 已售<?= $v['shop_num'];?>件
                        </div>
                        <div class="name"><a href="<?= Url::to(['product/product','goods_id'=>$v['goods_id']]);?>"><?= $v['keywords'];?></a></div>
                        <div class="carbg">
