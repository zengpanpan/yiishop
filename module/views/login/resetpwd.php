...
<div class="row-fluid login-wrapper">
    ...
    <div class="span4 box">
        <div class="content-wrap">
            ...
            <h6>电子商城 - 重置密码</h6>
            <?= $form->field($model,'admin_pwd')->passwordInput(['class'=>'span12','placeholder'=>'新密码'])->label('');?>
            <?= $form->field($model,'admin_rpwd')->passwordInput(['class'=>'span12','placeholder'=>'确认密码'])->label('');?>
            <a href="<?=Url::to(['login/login']);?>" class="forgot">登陆</a>

            <?= Html::submitButton('确认修改',['class'=>'btn-glow primary login'])?>
        </div>
    </div>
    <?php ActiveForm::end();?>
