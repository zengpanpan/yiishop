            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span9 with-sidebar">
                    <div class="container">
                        ...
                        <div class="span12 field-box">
                            <?= $form->field($user,'user_name')->textInput(['class'=>'span5']);?>

                        </div>


                        <div class="span12 field-box">
                            <?= $form->field($user,'user_pwd')->passwordInput(['class'=>'span5']);?>
                        </div>
                        <div class="span12 field-box">
                            <?= $form->field($user,'user_rpwd')->passwordInput(['class'=>'span5']);?>
                        </div>
                        <div class="span12 field-box">

                            <?= $form->field($user,'email')->textInput(['class'=>'span5']);?>
                        </div>
                        <div class="span12 field-box">

                            <?= $form->field($user,'user_phone')->textInput(['class'=>'span5']);?>
                        </div>
                ...
                <div class="span3 form-sidebar pull-right">
                    ...
                    <div class="alert alert-info hidden-tablet">
                        ...
                        请在左侧填写会员相关信息，包括管理员账号，电子邮箱，号码，以及密码
                    </div>
                    <h6>重要提示：</h6>
                    <p>管理员可以在前台购物</p>
                    <p>请愉快添加</p>
