                ...
                <div class="span9 with-sidebar">
                    <div class="container">
                        ...
                        <div class="span12 field-box">
                            <?= $form->field($category, 'pid')->dropdownList($cateList,['prompt'=>'顶级分类']); ?>
                        </div>
                        <div class="span12 field-box">
                            <?= $form->field($category,'cate_name')->textInput(['class'=>'span5','placeholder'=>'分类名']);?>

                        </div>


                        <div class="span12 field-box">
                            <?= $form->field($category,'sort')->textInput(['class'=>'span5','placeholder'=>'排序值越大越靠前']);?>
                        </div>
