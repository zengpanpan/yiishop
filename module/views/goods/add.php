            ...
            <div id="pad-wrapper" class="form-page">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span8 column">
                        ...
                        <div class="field-box">
                            <?= $form->field($goods,'promote_start_date')->textInput(['class'=>'input-large datepicker','placeholder'=>date('d/m/Y',time())])?>

                        </div>
                        <div class="field-box">
                            <?= $form->field($goods,'promote_end_date')->textInput(['class'=>'input-large datepicker','placeholder'=>date('d/m/Y',time()+3600*24)])?>
