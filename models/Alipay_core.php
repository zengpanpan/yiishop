...
use yii\base\Model;
use Yii;
class Alipay_core extends Model{
	var $alipay_config;
	/**
	 *支付宝网关地址（新）
	 */
     ...
     * @return 提交表单HTML文本
     */
	function buildRequestForm($data,$method, $button_name) {
		$para_temp = $this->getparameter($data);
		//待请求参数数组
		$para = $this->buildRequestPara($para_temp);
     ...
     * @return 支付宝返回处理结果
     */
	function buildRequestHttpInFile($file_para_name, $file_name) {
...
$alipay_config['transport']    = 'http';
		...
		"payment_type"	=> '1',
		"notify_url"	=> 'localhost/alipay/return_url.php',
		"return_url"	=> 'http://yii.shop.com/index.php?r=cart/success',
		"out_trade_no"	=> 11111111,   //订单号
		"subject"	=> '11111111'.time(),         //订单名字
		"total_fee"	=> '0.1',               //金额
		"body"	=> '',                            //描述
		"show_url"	=> '',                     //展示地址
		"anti_phishing_key"	=> '',            //防钓鱼时间戳
		"exter_invoke_ip"	=> '',              //客户端IP
